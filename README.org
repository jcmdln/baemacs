...
#+BEGIN_SRC shell :eval no :tangle no
  $ git clone https://gitlab.com/jcmdln/baemacs.git ~/.config/emacs
#+END_SRC
...
byte-compile the two managed files, finally loading the ~init.el~.  This will
...
#+BEGIN_SRC emacs-lisp :tangle init.el
  ;;; init.el ---- Baemacs initialization file Commentary:
