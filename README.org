...
this value to 4,000,000 globally, which ideally will reduce the total number of
...
#+BEGIN_SRC emacs-lisp :tangle early-init.el
  ...
  (setq gc-cons-threshold-default gc-cons-threshold
        gc-cons-threshold-tuned   (* 1000 1000 4)
...
#+BEGIN_SRC emacs-lisp :tangle config.el
  (use-package circe
    ...
    (setq circe-default-part-message ""
          ...
          circe-reduce-lurker-spam   'true
          circe-use-cycle-completion 'true
...
#+BEGIN_SRC emacs-lisp :tangle config.el
  (use-package docker-compose-mode
    :mode (("\\docker-compose.yml\\'" . dockerfile-mode)
           ("\\podman-compose.yml\\'" . dockerfile-mode)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle config.el
  (use-package meson-mode
    :mode ("\\meson.build\\'" . markdown-mode))
#+END_SRC
