...
than a configuration file we've written out, your entire configuration will be
tangled, compiled, and loaded automatically.
...
don't want to turn it into some other editor.
