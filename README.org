...
#+BEGIN_SRC shell :eval no :tangle no
  $ sudo dnf install -y autoconf automake dbus-devel gcc-devel gnutls-devel \
    gpm-devel jansson-devel libgccjit-devel libselinux-devel ncurses-devel \
    systemd-devel
  $ git clone --branch master --depth 1 https://github.com/emacs-mirror/emacs
  $ cd emacs
  $ ./autogen.sh
  $ ./configure CC="gcc" CFLAGS="-O3 -g3 -march=native -pipe" \
    --without-all \
    --without-x \
    --with-dbus \
...
#+BEGIN_SRC shell :eval no :tangle no
  ...
  (progn
    ...
    (native-compile \"~/.config/emacs/early-init.el\")
    (native-compile \"~/.config/emacs/init.el\")
    (native-compile \"~/.config/emacs/config.el\")
...
#+BEGIN_SRC emacs-lisp :tangle init.el
  ...
  (defun baemacs-reconfig()
    ...
    (native-compile (concat user-emacs-directory "early-init.el"))
    (native-compile (concat user-emacs-directory "init.el"))
    (native-compile (concat user-emacs-directory "config.el"))
