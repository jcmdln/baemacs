...
#+NAME: fig:1
#+CAPTION: What Baemacs looks like on startup
#+ATTR_HTML: :style margin: inherit auto;
[[./img/baemacs.png]]]
...
#+BEGIN_SRC emacs-lisp :tangle config.el
  (use-package diff-hl
    ...
    :hook
    (((conf-mode org-mode prog-mode text-mode) . diff-hl-mode)
     ((conf-mode org-mode prog-mode text-mode) . diff-hl-margin-mode)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle config.el
  (use-package smartparens
    :demand t
    :hook
    (((conf-mode eshell-mode prog-mode text-mode) . smartparens-mode)
     ((markdown-mode org-mode) . smartparens-mode))
